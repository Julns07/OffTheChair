  ...
  render() {
    ...
    if (this.state.anonymous) {
      alert = (
        ...
        >
          The {this.props.name.toLowerCase()} exercise has been added to your
          workout.
          <br />
          <small>
            Warning imformation will be stored temporarily and will not be
            retreived upon logging in. Please signup to write to database.
          </small>
        </Alert>
      )
    } else {
        ...
        <Fade bottom>
          <Card outline body color="dark" className="card p-4" inverse>
            ...
            <CardTitle className="title">
              {this.props.name}
              <FontAwesome name="info" style={{ float: "right" }} />
            </CardTitle>
                ...
                <Button
                  ...
                  onClick={() => {
                    this.props.userSelected(
                      this.props.frontMuscles,
                      this.props.backMuscles
                    )
                  }}
                >
                  View Muscles
